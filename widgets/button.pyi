...
class Button(_ColoredWidget):
    ...
    @overload
    @staticmethod
    def simpleButton(size: tuple[vars.validScreenUnit], position: vars.coordinate, backgroundColor: vars.RGBvalue = Color.LIGHT_GRAY, borderColor: vars.RGBvalue = Color.BLACK, borderWidth: int = 0) -> bool: ...
    @overload
    @staticmethod
