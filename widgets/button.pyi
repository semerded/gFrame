...
class Button(_ColoredWidget):
    @overload
    def __init__(self, size: list[vars.validScreenUnit], color: vars.RGBvalue, borderRadius: int = -1) -> None: ...
    @overload
    def __init__(self, width: vars.validScreenUnit, height: vars.validScreenUnit, color: vars.RGBvalue, borderRadius: int = -1) -> None: ...
    
    @overload
    @staticmethod
    def simpleButton(size: list[vars.validScreenUnit], position: vars.coordinate, backgroundColor: vars.RGBvalue = Color.LIGHT_GRAY, borderColor: vars.RGBvalue = Color.BLACK, borderWidth: int = 0) -> bool: ...
    @overload
    @staticmethod
    def simpleButton(width: vars.validScreenUnit, height: vars.validScreenUnit, left: vars.validScreenUnit, top: vars.validScreenUnit, backgroundColor: vars.RGBvalue = Color.LIGHT_GRAY, borderColor: vars.RGBvalue = Color.BLACK, borderWidth: int = 5,) -> bool: ...
    @overload
    @staticmethod
    def simpleButton(rect: Rect, backgroundColor: vars.RGBvalue = Color.LIGHT_GRAY, borderColor: vars.RGBvalue = Color.BLACK, borderWidth: int = 5) -> bool: ...
