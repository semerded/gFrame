...
class _BaseWidget:
    @overload
    def __init__(self, size: tuple[vars.validScreenUnit, vars.validScreenUnit], borderRadius: vars.validScreenUnit = -1) -> None: ...
    @overload
    def __init__(self, width: vars.validScreenUnit, height: vars.validScreenUnit, borderRadius: vars.validScreenUnit = -1) -> None: ...
