...
class Text:
    ...
    def placeInRect(self, rect: Rect, xPositioning: xTextPositioning = xTextPositioning.center, yTextPositioning: yTextPositioning = yTextPositioning.center, newText: str = None): ...
